...
class PersonnelLoginWidget extends StatefulWidget {
  PersonnelLoginWidget({Key? key, required this.loggedIn}) : super(key: key);
  bool loggedIn;

  @override
  _PersonnelLoginWidgetState createState() => _PersonnelLoginWidgetState();
}

class _PersonnelLoginWidgetState extends State<PersonnelLoginWidget> {
